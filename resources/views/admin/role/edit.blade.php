...
@include('patials.content-header', ['name' =>'Roles ','key'=>'Edit'])
    <div class="content">
            ...
            <div class="col-md-12" >
                ...
                <div class="card border-primary mb-3 col-md-12">
                  ...
                  <div class="row">
                    ...
                    <h5 class="card-title">
                      <label for="">
                        <input type="checkbox" class="checkbox_children" {{ $permissionchecked->contains('id', $item->id) ? 'checked' : '' }} name="permission_id[]" value="{{ $item->id }}">
                      </label>
                    {{ $item->name}}
                    </h5>
                  </div>
